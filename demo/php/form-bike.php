      ...
      <div class="container">
         ...
         <div class="form">
            <div class="contact_dtl">
               <h3>Transport service in India includes</h3>
                           <ul>
                               <li>Freight forwarding</li>
                               <li>House Shifting</li>
                               <li>Warehousing services</li>
                               <li>Air consignment firms</li>
                               <li>Carand Bike transportation</li>
                               <li>Hiring truck or tempo service</li>
                               <li>Office Relocation</li>
                               <li>Domestic Services</li>
                               <li>International Services</li>
                               <li>Cargo Services</li>
                           </ul>
                           <img alt="What are the benefits you get when you hire Local Transporters from us?" src="https://www.grewaltransportservice.com/img/grewal/trans/all-transport-services.webp" width="100%" height="300">
            </div>
