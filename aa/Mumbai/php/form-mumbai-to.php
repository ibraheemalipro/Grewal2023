         ...
         <div class="form">
            <div class="contact_dtl">
               ...
               <p>Hiring Grewal transport company is that you will receive your household stuff safely at your destination</p>
                           <ul>
                               <li>A customized route plan for bulk transport between multiple points</li>
                               <li>Pan-India single-window service</li>
                               <li>A vendor network that ensures reliable truck availability</li>
                               <li>Deliveries are safer and faster with a double-driver</li>
                               <li>The fleet is fresh with containerized trucks and one-time seals</li>
                               <li>Control centers that track vehicles in real-time</li>
                               <li>24×7 customer care</li>
                               <li>Transshipment without damage, no transshipment</li>
                               <li>Even during high seasons, prices are reasonable</li>
                               <li>Supply chain management from beginning to end</li>
                           </ul>
                           <img alt="Transport Services in Delhi" src="https://imagedelivery.net/GszeG3iAQivExkh9MpZwAA/d69b6bd4-baed-4e82-5f2f-4f1077903500/charges" width="100%" height="300">
            </div>
