...
<div class="container">
	<div class="footer_logo"><a href="https://www.grewaltransportservice.com"><img alt="Grewal Transport logo" longdesc="#" src="image/logo.webp" width="300" height="70"></a></div>
...
<!--<div class="fix-icon">
<div class="fix-icon-item" id="fix-icon"><a href="tel:9911076600" target="blanck"><img alt="bike transport" src="image/phone-icon.webp" title="9911076600" /></a></div>
</div> -->
<div class="fix-icon-whataap">
<div class="fix-icon-whataap-item" id="fix-icon-whataap"><a href="https://api.whatsapp.com/send?phone=+919911076600&amp;text=&amp;source=&amp;data=" target="blanck"><img alt="bike transport" src="image/whatsapp.svg" title="9911076600" /></a></div>
</div>
